...
| Warp (cruise) | 2c | 5 MN | 5 GW | Indefinite |
| Warp (high) | 5c | 8 MN | 20 GW | 30 days |
| Warp (maximum) | 10c | 10 MN | 50 GW | 7 days |
| Emergency | 15c | 15 MN | 100 GW | 24 hours |

### Speed Calculations

**Maximum speed: 10c** (10× speed of light)
...
| Ramp | 300 sec | 0.1c → 2c | 1 → 5 MN | None |
| Cruise | Indefinite | 2c | 5 MN | None |
| Boost | 600 sec | 2c → 10c | 5 → 10 MN | None |
| Maximum | 7 days | 10c | 10 MN | None |
| Deceleration | 300 sec | 10c → 2c | 10 → 5 MN | None |
| Approach | 300 sec | 2c → 0 | 5 → 0 MN | None |
...
| Hazard | Mitigation | Status |
|--------|------------|--------|
| Overspeed | Automatic governor (10c limit) | Automatic |
...
|-----------|----------|-----------|-----------------|----------|
| Maximum speed | 0.001c | 0.01c | 0.05c | 10c |
