# PHI TIME SHUTTLE — WIRING DIAGRAM
...
## TEMPORAL COIL WIRING (Per Coil)

```
┌──────────────────────────────────────────────────────────────────────┐
│              PHI-HARMONIC TEMPORAL COIL (Per Unit)                   │
│                                                                      │
│  ┌────────────────────────────────────────────────────────────┐      │
│  │              POWER INPUT                                    │      │
│  │                                                             │      │
...
│  │          │  Resonant freq:                                    │      │
│  │          │  f₀ = 1/(2π√LC)                                  │      │
│  │          │  f₀ ≈ 90.9 kHz  ← Fundamental                    │      │
│  │          │  φ-harmonic: 147.1, 237.9, 385.0, 622.9 kHz     │      │
│  │          └───────────────────┘                              │      │
│  │                                                             │      │
│  │          ┌───────────────────┐                              │      │
│  │          │  TEMPORAL FOLD    │                              │      │
...
│                                                                      │
│  ┌──────────────────────────────────────────────────────────┐        │
│  │         NAVIGATION COMPUTER (Raspberry Pi 4, ×2)         │        │
│  │                                                          │        │
│  │  POWER:                                                  │        │
│  │    USB-C ◄──── 48V→12V DC-DC (5kW)                      │        │
│  │    12V  ────► Sensor Power (atomic clock, IMU, probes)   │        │
...
│  │    GPIO 8  ──► Temporal Radar Trigger                     │        │
│  │    GPIO 9  ──► Coherence Sensor Read                     │        │
│  │    GPIO 10 ──► Chronology Monitor INT                    │        │
│  │    GPIO 11 ──► Safety Abort Trigger                      │        │
│  │    GPIO 17 ──► Navigation Display (SPI)                  │        │
│  │    GPIO 22 ──► Atomic Clock Sync                         │        │
...
│  │    VCC ──► 12V (regulated)                               │        │
│  │    GND ──► GND                                           │        │
│  │    1PPS ──► Pi GPIO 22 (sync pulse)                      │        │
│  │    FREQ ──► Pi GPIO 22 (10MHz ref)                       │        │
│  │                                                          │        │
│  │  TEMPORAL RADAR:                                         │        │
...
│  │                                                          │        │
│  │  ABORT SYSTEM:                                           │        │
│  │    D36 ──► Coil Power Cut (all 8 coils)                  │        │
...
│  │                                                          │        │
│  │  CH1: 90.9 kHz (fundamental) ──► PLL Bank 1-4           │        │
│  │  CH2: 147.1 kHz (φ-harmonic) ──► PLL Bank 5-8           │        │
│  │                                                          │        │
│  │  Output: 5Vpp sine wave                                  │        │
│  │  Sync: 1PPS from atomic clock                            │        │
│  └──────────────────────────────────────────────────────────┘        │
│                              │                                       │
│                    ┌─────────┴─────────┐                             │
│                    │  PHASE-LOCK LOOP  │                             │
...
│                      │1││2││3││4││5││6││7││8│                     │
│                      └─┘└─┘└─┘└─┘└─┘└─┘└─┘└─┘                      │
│                       Coil positions (bi-toroidal array)             │
│                                                                      │
└──────────────────────────────────────────────────────────────────────┘
```
...
│   Coil GND: Temporal coil return paths (dedicated)                   │
...
│                                                                      │
│   SHIELDING:                                                          │
│   - Hull: Aluminum Faraday cage (>70 dB, 100kHz-1GHz)               │
...
| Coil Feed (per coil) | 4 AWG | Red | 400A | Superconductor leads |
| Coil Return | 4 AWG | Black | 400A | Dedicated return |
| Quench Bus | 4 AWG | Orange | 500A | Emergency dump |
| Aux Bus (48V) | 2 AWG | Red/Black | 100A | To DC-DC converters |
...
| HV Coil Lead | 10mm Silicone | Red | 6000A | Superconductor feed |
